...
function Slider() {
  return (
    <section id="slider-section" className="bg-gradient-to-br from-blue-50 to-white py-16 border-b border-gray-200 relative font-poppins">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-4">
        ...
        <div className="flex-1 max-w-lg">
          ...
          <div className="flex gap-3">
            <button className="bg-blue-500 text-white px-9 py-3 rounded font-medium hover:bg-blue-600 font-poppins">
              Contact us
            </button>
            <button className="border border-blue-500 text-blue-500 px-9 py-3 rounded font-medium hover:bg-blue-50 font-poppins">
              View more
            </button>
          </div>
        </div>
