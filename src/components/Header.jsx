...
function Header() {
  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-blue-100">
        <div className="max-w-[1600px] w-full mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 py-8 h-16">
          {/* Left: Logo */}
          ...
          <button
            ...
            className="md:hidden p-2 text-gray-600 hover:text-[#1090CB]"
          >
            <svg
              className="w-6 h-6"
              fill="none"
          ...
          <div
            ...
            } md:flex absolute md:relative top-16 md:top-0 left-0 right-0 md:right-auto bg-white md:bg-transparent flex-col md:flex-row items-center gap-4 md:gap-8 py-4 md:py-0 border-b md:border-none shadow-lg md:shadow-none transition-all duration-300 z-50 w-full md:w-auto`}
          >
            {/* Navigation Links */}
