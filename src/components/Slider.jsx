...
function Slider() {
  return (
    <section className="bg-gradient-to-br from-blue-50 to-white py-16 border-b border-gray-200 relative"> {/* ✅ Add 'relative' for absolute positioning */}
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-4">
        ...
        <div className="flex-1 max-w-lg">
          ...
          <div className="flex gap-3">
            <button className="bg-blue-500 text-white px-5 py-2 rounded font-medium hover:bg-blue-600">
              Contact us
            </button>
            <button className="border border-blue-500 text-blue-500 px-5 py-2 rounded font-medium hover:bg-blue-50">
              View more
            </button>
          </div>
        </div>
